...
void csg_s::csg_s_operations::addRadiusValue(int x, int y, VIBe::dataLayer * layer, int rmax)
{
	csg_s_operations::addRadiusValue(x, y, layer, rmax, 0.);
}

void csg_s::csg_s_operations::addRadiusValue(int x, int y, VIBe::dataLayer * layer, int rmax, double value) {
        int level = rmax;
        if (rmax > 500) {
                rmax = 500;
        }
...
void csg_s::csg_s_operations::addRadiusValueADD(int x, int y, VIBe::dataLayer * layer, int rmax, double value)
{
	int level = rmax;
        if (rmax > 500) {
                rmax = 500;
...
void csg_s::csg_s_operations::exportRaster(QString name, VIBe::dataLayer * layer_, double multiplikator)
{
...
void csg_s::csg_s_operations::findSewer(VIBe::dataLayer * Input, VIBe::dataLayer * Output)
{
...
void csg_s::csg_s_operations::intSewerNetwork(VIBe::dataLayer * InitSewer, VIBe::dataLayer * ResultField)
{
