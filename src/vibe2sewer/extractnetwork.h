...
class VIBE_HELPER_DLL_EXPORT ExtractNetwork : public  Module {
VIBe_DECLARE_NODE ( ExtractNetwork )
public:
...
VectorData * ExportPath;
VectorData * existingNetwork;
VectorData * StartPointsOut;
...
std::vector<std::vector<Point> > SimplifyNetwork(std::vector<std::vector<Point> >  & points, int PReduction, double offset);
void smoothNetwork();
public:
ExtractNetwork();
void run();
